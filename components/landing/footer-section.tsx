...
export function FooterSection() {
  return (
    <footer className="border-t border-white/[0.06] bg-[#030712] relative">
      <div className="max-w-7xl mx-auto py-16 px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          >
            ...
            <p className="text-sm text-slate-400 leading-relaxed mb-6 max-w-[260px]">
              Zero-Trust security infrastructure for autonomous AI agents.
              Protect, monitor, and govern every request.
            </p>
        ...
        <div className="border-t border-white/[0.06] mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-slate-500">
            © 2026 AegisMesh, Inc. All rights reserved.
          </p>
